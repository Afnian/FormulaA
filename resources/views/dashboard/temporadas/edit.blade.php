...
@section('title', 'Editar Temporada — Panel')
@section('page-title', 'Editar temporada')
@section('page-subtitle', $temporada->nombre)
...
<div class="row justify-content-center">
    <div class="col-lg-6">
        ...
        <div class="table-panel p-4">
            <form method="POST"
                  action="{{ route('dashboard.temporadas.update', $temporada->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre"
                           ...
                           value="{{ old('nombre', $temporada->nombre) }}" required>
                    @error('nombre')
                ...
                <div class="mb-3">
                    ...
                    <select name="categoria"
                            ...
                            required>
                        <option value="formula_a"
                            {{ old('categoria', $temporada->categoria) === 'formula_a' ? 'selected' : '' }}>
                            Fórmula A
                        </option>
                        <option value="formula_b"
                            {{ old('categoria', $temporada->categoria) === 'formula_b' ? 'selected' : '' }}>
                            Fórmula B
                        </option>
                    </select>
                    @error('categoria')
                ...
                <div class="mb-4">
                    <div class="form-check">
                        <input type="checkbox" name="activa" value="1"
                               ...
                               id="activa"
                               {{ old('activa', $temporada->activa) ? 'checked' : '' }}>
