...
@section('title', 'Mundial de Pilotos — Fórmula A')
...
<div class="container">
    ...
    <div class="card-fa p-3 mb-4">
        <form method="GET" action="{{ route('clasificaciones.pilotos') }}"
            ...
            @if($eventoFiltro)
                <a href="{{ route('clasificaciones.pilotos') }}"
